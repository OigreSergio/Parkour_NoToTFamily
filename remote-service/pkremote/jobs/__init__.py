...
- dalla riga di comando: `pkremote job <nome>` (in remoto, per esempio, come
  comando pianificato del provider o da un workflow GitHub);
...
from pkremote.jobs.base import REGISTRY, JobContext, JobResult, register, run_job

__all__ = ["REGISTRY", "JobContext", "JobResult", "register", "run_job"]
